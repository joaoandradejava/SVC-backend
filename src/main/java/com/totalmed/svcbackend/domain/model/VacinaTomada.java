...
public class VacinaTomada {
	...
	@ManyToOne
	@JoinColumn(name = "carteira_vacinacao_id")
	private CarteiraVacinacao carteiraVacinacao;

	public VacinaTomada() {
	}

	public VacinaTomada(Long id, String nome, LocalDate data, CarteiraVacinacao carteiraVacinacao) {
		super();
		this.id = id;
		this.nome = nome;
		this.data = data;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VacinaTomada other = (VacinaTomada) obj;
		if (id == null) {
			if (other.id != null)
				return false;
